...
class ExtraExtension extends \Twig_Extension {
    ...
    public function getFunctions() {
        ...
        return array(
            ...
            'repository' => new \Twig_SimpleFunction($this, 'getRepository'),
            'match' => new \Twig_SimpleFunction($this, 'regexMatch'),
            'matches' => new \Twig_SimpleFunction($this, 'regexMatches'),
            'replace' => new \Twig_SimpleFunction($this, 'regexReplace'),
        );
    }
    ...
    public function getFilters() {
        return array(
            'query_string' => new \Twig_SimpleFilter($this, 'getQueryString'),
            'unset' => new \Twig_SimpleFilter($this, 'unsetValue'),
            'url_slug' => new \Twig_SimpleFilter($this, 'getUrlSlug'),
            'date_diff' => new \Twig_SimpleFilter($this, 'getDateDiff'),
            'date_locale' => new \Twig_SimpleFilter($this, 'getLocaleDate'),
            'date_modify' => new \Twig_SimpleFilter($this, 'getModifiedDate'),
            'abbr' => new \Twig_SimpleFilter($this, 'abbreviate'),
            'md5' => new \Twig_SimpleFilter($this, 'getMD5String'),
        );
    }
